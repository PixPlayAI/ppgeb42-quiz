...
- Foque nos conceitos de colimação, blindagem e materiais atenuadores
      ...
      try {
        ...
        if (!generatedContent.successMessage || !generatedContent.detailedExplanation) {
          ...
          generatedContent.detailedExplanation =
            ...
            '1. O material apropriado (chumbo) tem um alto coeficiente de atenuação, permitindo uma colimação eficaz das partículas.\n' +
            '2. O material inapropriado (madeira) tem um baixo coeficiente de atenuação, resultando em maior espalhamento das partículas.\n\n' +
