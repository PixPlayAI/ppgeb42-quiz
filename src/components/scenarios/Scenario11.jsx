...
Retorne a resposta EXATAMENTE neste formato JSON:
{
  ...
  "successMessage": "[Mensagem de parabéns explicando por que a resposta está correta e reforçando o conceito que o aluno dominou], não cite alternativa abcd ou 1234 pois elas são embaralhadas",
...
const Scenario11 = ({ isPlaying, isDark, scenarioNumber = 1 }) => {
